...
Game_CharacterBase.prototype.getSmartJumpDistance = function(distance) { 
    if (this._direction === 2) {
      for (var i = 0; i < distance; i = i + 0.25) {
        if (this.y + i + 0.5 > $gameMap.height() || this.isSmartJumpIllegalRegion(Math.round(this.x), Math.round(this.y) + i + 0.25) || this.z < mv3d.getWalkHeight(this.x + 0.33,this.y + i + 0.51)  || this.z < mv3d.getWalkHeight(this.x - 0.33,this.y + i + 0.51)) {
          distance = i;
          break;
        }
      }
      ...
      for (var i = 0; i < distance; i = i + 0.25) {
        if (this.x - i - 0.5 < 0 || this.isSmartJumpIllegalRegion(Math.round(this.x) - i - 0.25, Math.round(this.y)) || this.z < mv3d.getWalkHeight(this.x - i - 0.51,this.y - 0.33) || this.z < mv3d.getWalkHeight(this.x - i - 0.51,this.y + 0.33)) {
          distance = i;
          break;
        }
      }
      ...
      for (var i = 0; i < distance; i = i + 0.25) {
        if (this.x + i + 0.5 > $gameMap.width() || this.isSmartJumpIllegalRegion(Math.round(this.x) + i + 0.25, Math.round(this.y)) || this.z < mv3d.getWalkHeight(this.x + i + 0.51,this.y - 0.33) || this.z < mv3d.getWalkHeight(this.x + i + 0.51,this.y + 0.33)) {
          distance = i;
          break;
        }
      }
      ...
      for (var i = 0; i < distance; i = i + 0.25) { 
        if (this.y - i - 0.5 < 0 || this.isSmartJumpIllegalRegion(Math.round(this.x), Math.round(this.y) - i - 0.25) || this.z < mv3d.getWalkHeight(this.x + 0.33,this.y - i - 0.51) || this.z < mv3d.getWalkHeight(this.x - 0.33,this.y - i - 0.51)) {
          distance = i;
          break;
        }
      }
...
Game_CharacterBase.prototype.calcSmartJumpDistance = function(distance) {
    ...
    if (this._direction === 2) {
      for (var i = 0; i < max; ++i) {
        if (this.isSmartJumpValid(Math.round(this.x), Math.round(this.y) + max)) {
          value = max - i;
          break;
        }
      }
      ...
      for (var i = 0; i < max; ++i) {
        if (this.isSmartJumpValid(Math.round(this.x) - max, Math.round(this.y))) {
          value = max - i;
          break;
        }
      }
